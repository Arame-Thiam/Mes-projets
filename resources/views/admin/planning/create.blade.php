...
@extends('layouts.app')
    @section('content')
         ...
         <div class="login">
         <h1 class="titre">Ajouter des plannings</h1>
            <form action="{{route('planning.store')}}" method="POST">
              @csrf
                ...
                <div>
                    ...
                    <input class="item-input" type="text" placeholder="lieu" name="lieu">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input class="item-input" type="date" name="date">
                </div>
                <div>
                    <label for="">Heure</label>
                    <input class="item-input" type="time" name="heurs">
                </div>
                <div>
                ...
                <div>
                  ...
                  @foreach ($user as $med)
                    <option value="{{$med->id}}">{{$med->id}}</option>    
                  @endforeach
                  </select>
              </div>
                <br>
